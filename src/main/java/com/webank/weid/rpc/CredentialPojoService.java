...
public interface CredentialPojoService {
     ...
     *
     * @param credentialPojoList user's credentialPojo list
     * @param policyAndChallenge generated by verifier
     * @param toOrgId (待确认的点，此参数在AMOP中是必须的，但是HTTP或者其他传输层实现不一定有)
     * @param transportationType enum value, specify a transpotation type
     * @param weIdAuthentication user's authentication info
     ...
     * @param transportationType enum value, specify a transpotation type
     * @param weIdAuthentication user's authentication info
     * @return status of transfering
     */
    ResponseData<Integer> transferCreditCredential(
        List<CredentialPojo> credentialPojoList,
        PolicyAndChallenge policyAndChallenge,
        String toOrgId,
        TransportationType transportationType,
