...
public interface AmopService {
    ...
    /**
     * request policyAndChallenge and transfer argument.
    ...
    /**
     * (待讨论接口，暂时不用)
     * transfer user's presentation and consumable credential.
     * @param toOrgId orgId the id of the target organization
